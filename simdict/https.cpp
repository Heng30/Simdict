...
Https::Https(QObject *parent, const QString &content)
    : QObject(parent), m_url(""), m_searchContent(content),
...
void Https::setUserAgent(const QString &userAgent) { m_userAgent = userAgent; }

void Https::setUrl(const QString &url) { m_url = url; }

QString Https::getSearchContent() { return m_searchContent; }
